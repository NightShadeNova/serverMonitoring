...
from monitor_app.views import get_metrics, DashboardView, MetricsFetch, ActiveAlerts, LatestRecordFetch

urlpatterns = [
    path('admin/', admin.site.urls),
    path('api/v1/metrics/push/', get_metrics, name="metrics_push"),
